...
<head>
    ...
    <title>Registro — TicketWave</title>
...
<body>
    ...
    {{-- CARD CENTRADA — con overflow-y para pantallas pequeñas --}}
    <div style="position:relative; z-index:2; min-height:100vh; display:flex; align-items:center; justify-content:center; padding:1.5rem 1rem; overflow-y:auto;">
        <div class="card">
